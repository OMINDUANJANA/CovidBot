...
def staat(qq):
  ...
  data = {
    "chat_id": str(qq),
    "photo": "https://avatars.githubusercontent.com/u/93399269?v=4",
    "caption": "ශ්‍රී ලංකාවේ කොරෝනා තතු එසැනින් දැනගන්න. @BlackAlphaCovid19Bot Group එකට Add කරගත් පසු ස්වයංක්‍රියව නවතම කොරෝනා තතු ලබාගත හැක.  වැඩි විස්තර සදහා /help භාවිතා කරන්න.     ~ @Black Alpha | @Rasah ",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
...
def staa():
    ...
    textt = str(
                    ...
                    '✅ සියලු තොරතුරු රජයේ සහ පිලිගත් එවා මගිනි' + '\n' +
                    '~ Developed By Black Alpha ~')
    return textt
